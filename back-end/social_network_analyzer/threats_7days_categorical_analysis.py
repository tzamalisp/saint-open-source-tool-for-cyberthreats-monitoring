...
def findMostFrequentHashtags():
    ...
    try:
        ...
        print('Fetched successfully the data from the database in:', timeduration)
...
def findMostFrequentTerms():
    ...
    stopwordList = stopwords.words('english') + punct + ['rt', 'via', '…', '...', '..', 'yang', "i'm",
                                                         ...
                                                         'sex', 'shots', 'cum', 'hi', 'tencent', 'hoops', 'tourney',
                                                         'vs', 'boyz', 'coming', 'break',
                                                         'music', 'video', 'generations', 'ballistik', 'jr.exile',
                                                         '7/2', 'exile', 'tribe', 'battle', 'tokyo', 'riku', 'live',
                                                         'ready', 'today', 'jr', 'che', 'del', 'free']
