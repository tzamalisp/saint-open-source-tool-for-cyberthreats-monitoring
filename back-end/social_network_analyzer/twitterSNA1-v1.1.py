...
if __name__ == '__main__':
    ...
    hash.to_csv('/var/www/html/saint/twitterSNA-Aug17/hashesSNA1.csv')
    print('hash:')
    print(hash.head())
    ...
    terms.to_csv('/var/www/html/saint/twitterSNA-Aug17/termsSNA1.csv')
    print('terms:')
    print(terms.head())
    ...
    mentions.to_csv('/var/www/html/saint/twitterSNA-Aug17/mentionsSNA1.csv')
    print('mentions:')
    print(mentions.head())
    ...
    s.to_csv('/var/www/html/saint/twitterSNA-Aug17/perdayTimeSeries01SNA1.csv')